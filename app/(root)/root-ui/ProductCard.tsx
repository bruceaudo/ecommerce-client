...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return <div className="w-full lg:h-72 sm:h-96 h-fit py-3 bg-white border rounded-lg cursor-pointer hover:shadow-lg">
      <Link href={`/product/${link}`}>
        <div className="h-4/5 flex items-center justify-center">
            <Image src={imageURL[0]} alt="product_image" width={250} height={250} />
        </div>
